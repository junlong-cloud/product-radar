...
export const starterSkills: StarterSkill[] = [
  ...
  // ---- rising 本周新星：GitHub Trending Weekly TOP 10（按本周新增 stars 倒序，每周快照） ----
  {
    ...
    oneLiner: "Archify 是一个智能体技能，能生成美观且可验证的架构图、流程图、时序图等，输出为自包含 HTML，支持动画和清晰导出。",
    signal: "tt-a1i/archify · 总 51.2k stars",
    why: "AI 产品经理可快速生成架构图，便于文档和演示，提升沟通效率。",
    link: "https://github.com/tt-a1i/archify",
    weeklyDelta: 17190,
  },
  {
    slug: "openmaic", name: "OpenMAIC", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "OpenMAIC 是一个开源的多智能体交互课堂，一键即可获得沉浸式多智能体学习体验。",
    signal: "THU-MAIC/OpenMAIC · 总 32.5k stars",
    why: "多智能体教育应用，值得关注 AI 在教育场景的产品形态。",
    link: "https://github.com/THU-MAIC/OpenMAIC",
    weeklyDelta: 9193,
  },
  {
    slug: "voicestudio", name: "VoiceStudio", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "VoiceStudio 是开源、完全本地的 ElevenLabs 替代品，支持语音克隆、语音设计、视频配音、听写、转录和有声书制作，覆盖 646 种语言。",
    signal: "debpalash/VoiceStudio · 总 20k stars",
    why: "本地化语音工具，适合产品经理探索语音 AI 应用，保护隐私且成本低。",
    link: "https://github.com/debpalash/VoiceStudio",
    weeklyDelta: 7513,
  },
  {
    slug: "minimind", name: "minimind", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "MiniMind 项目教你仅用 2 小时从零训练一个 6400 万参数的大语言模型。",
    signal: "jingyaogong/minimind · 总 59.2k stars",
    why: "快速理解 LLM 训练流程，适合产品经理建立技术直觉。",
    link: "https://github.com/jingyaogong/minimind",
    weeklyDelta: 3816,
  },
  {
    slug: "timesfm", name: "timesfm", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "TimesFM 是谷歌研究的时间序列基础模型，用于时间序列预测，可预训练后直接使用。",
    signal: "google-research/timesfm · 总 31.7k stars",
    why: "时间序列预测是 AI 产品常见需求，了解基础模型可加速方案选型。",
    link: "https://github.com/google-research/timesfm",
    weeklyDelta: 3203,
  },
  {
    slug: "patent-disclosure-skill", name: "patent-disclosure-skill", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "中国专利.skill 是一个技能，帮助挖掘专利点并撰写交底书，涵盖发明、实用、外观，还能解读专利和政策。",
    signal: "handsomestWei/patent-disclosure-skill · 总 8k stars",
    why: "AI 辅助专利撰写，对涉及知识产权保护的产品经理有实用价值。",
    link: "https://github.com/handsomestWei/patent-disclosure-skill",
    weeklyDelta: 2093,
  },
  {
    slug: "magnitude", name: "magnitude", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "Magnitude 是开源推理服务器，能在你的硬件上运行最佳本地模型，并接入你已有的智能体，支持多种工具。",
    signal: "magnitudedev/magnitude · 总 3.8k stars",
    why: "本地模型部署工具，帮助产品经理快速集成 AI 能力，降低云端依赖。",
    link: "https://github.com/magnitudedev/magnitude",
    weeklyDelta: 1961,
  },
  {
    slug: "openclaude", name: "openclaude", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "OpenClaude 是一个运行在任何地方、使用任何东西的开放 Claude 客户端。",
    signal: "Gitlawb/openclaude · 总 32.9k stars",
    why: "灵活接入 Claude，适合产品经理探索多环境 AI 应用。",
    link: "https://github.com/Gitlawb/openclaude",
    weeklyDelta: 1944,
  },
  {
    slug: "fmt", name: "fmt", category: "rising",
    tagline: "C++ · 热门",
    oneLiner: "fmt 是一个现代 C++ 格式化库，提供安全高效的字符串格式化功能。",
    signal: "fmtlib/fmt · 总 25.6k stars",
    why: "虽非 AI 专属，但作为基础库，了解可提升产品开发效率。",
    link: "https://github.com/fmtlib/fmt",
    weeklyDelta: 1885,
  },
  {
    slug: "microduck-rl", name: "microduck_rl", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "Microduck RL 为 Microduck 机器人提供强化学习训练环境，基于 mjlab。",
    signal: "pollen-robotics/microduck_rl · 总 1.8k stars",
    why: "机器人 RL 训练环境，对 AI 产品经理了解具身智能有参考价值。",
