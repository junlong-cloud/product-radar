...
export const starterSkills: StarterSkill[] = [
  ...
  // ---- rising 本周新星：GitHub Trending Weekly TOP 10（按本周新增 stars 倒序，每周快照） ----
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "开源智能视频制作系统，包含12条管线、52个工具和500+智能体技能，可将AI编程助手变为完整视频工作室。",
    signal: "calesthio/OpenMontage · 总 27.9k stars",
    why: "AI视频生成赛道新范式，产品经理可研究其智能体编排与工具链设计。",
  ...
  },
  {
    ...
    tagline: "C · 热门",
    oneLiner: "高性能代码智能MCP服务器，将代码库索引为持久知识图谱，支持158种语言，毫秒级查询，减少99%令牌消耗。",
    signal: "DeusData/codebase-memory-mcp · 总 20.6k stars",
    why: "提升代码理解效率的工具，适合评估AI辅助开发产品的知识管理方案。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "LLM驱动的多市场股票分析系统，集成行情、新闻、决策看板与自动推送，支持零成本定时运行。",
    signal: "ZhuLinsen/daily_stock_analysis · 总 51.5k stars",
    why: "AI+金融的落地案例，产品经理可参考其多源数据整合与自动化设计。",
  ...
  },
  {
    ...
    oneLiner: "一种描述视觉标识的格式规范，让AI编程助手持久理解设计系统。",
    signal: "google-labs-code/design.md · 总 23.1k stars",
    why: "规范AI与设计协作的接口，对AI产品经理设计人机交互流程有启发。",
  ...
  },
  {
    ...
    tagline: "TypeScript · 热门",
    oneLiner: "用一条命令通过AI编程代理克隆任何网站。",
    signal: "JCodesMore/ai-website-cloner-template · 总 23.2k stars",
    why: "展示AI代理在网站克隆场景的潜力，值得关注其自动化与准确性。",
  ...
  },
  {
    ...
    tagline: "Swift · 热门",
    oneLiner: "专为AI构建的macOS视频编辑器。",
    signal: "palmier-io/palmier-pro · 总 9.4k stars",
    why: "AI原生视频编辑工具，产品经理可观察其如何集成AI功能提升编辑效率。",
  ...
  },
  {
    ...
    why: "隐私通信赛道创新，产品经理可研究其去中心化与零标识设计。",
  ...
  },
  {
    ...
    tagline: "TypeScript · 热门",
    oneLiner: "用于管理并行代理集群的智能体开发环境，支持桌面和移动端，可运行任意编程代理。",
    signal: "stablyai/orca · 总 8.9k stars",
    why: "多智能体协作平台，适合产品经理探索代理工作流编排与规模化部署。",
  ...
  },
  {
    ...
    tagline: "Go · 热门",
    oneLiner: "一个防止错误提交的Git工具，确保推送前代码无误。",
    signal: "kunchenguid/no-mistakes · 总 4.2k stars",
    why: "小而美的开发者工具，体现AI在代码质量保障中的应用思路。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "用AI代理评估和筛选简历的招聘工具。",
    signal: "interviewstreet/hiring-agent · 总 3.4k stars",
    why: "AI招聘赛道典型应用，产品经理可分析其简历评分逻辑与公平性设计。",
