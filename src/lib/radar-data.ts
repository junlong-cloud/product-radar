...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "strix", name: "strix", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "开源AI渗透测试工具，自动发现并修复应用漏洞，提升安全性。",
    signal: "usestrix/strix · 总 37.8k stars",
    why: "AI安全赛道，产品经理可了解如何用AI自动化安全测试。",
    link: "https://github.com/usestrix/strix",
    weeklyDelta: 10338,
  },
  {
    slug: "exercises-dataset", name: "exercises-dataset", category: "rising",
    tagline: "HTML · 热门",
    oneLiner: "包含433个健身动作的数据集，含名称、类别、肌肉群、器材、指导及视频。",
    signal: "hasaneyldrm/exercises-dataset · 总 10.1k stars",
    why: "高质量结构化数据集，适合做健身类AI产品的内容基础。",
    link: "https://github.com/hasaneyldrm/exercises-dataset",
    weeklyDelta: 7084,
  },
  {
    slug: "ai-berkshire", name: "ai-berkshire", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "基于Claude/Codex的价值投资研究框架，融合四位大师方法论，多Agent并行分析。",
    signal: "xbtlin/ai-berkshire · 总 11k stars",
    why: "AI+金融投资的产品形态，多Agent协作模式值得借鉴。",
  ...
  },
  {
    ...
    oneLiner: "免费AI网关，一个接口连接231+模型提供商，支持压缩节省15-95% tokens。",
    signal: "diegosouzapw/OmniRoute · 总 12.3k stars",
    why: "降低AI调用成本，产品经理可快速集成多种模型。",
    link: "https://github.com/diegosouzapw/OmniRoute",
    weeklyDelta: 4411,
  },
  {
    slug: "video-use", name: "video-use", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "用编码智能体编辑视频，通过自然语言指令完成剪辑操作。",
    signal: "browser-use/video-use · 总 15.3k stars",
    why: "AI视频编辑新范式，产品经理可关注人机交互方式。",
  ...
  },
  {
    ...
    tagline: "Rust · 热门",
    oneLiner: "终端里的智能体多路复用器，管理多个AI代理的并发请求。",
    signal: "ogulcancelik/herdr · 总 12.6k stars",
    why: "提升AI代理效率的工具，适合多Agent系统产品设计参考。",
    link: "https://github.com/ogulcancelik/herdr",
    weeklyDelta: 3937,
  },
  {
    slug: "page-agent", name: "page-agent", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "JavaScript页面内GUI智能体，用自然语言控制网页界面。",
    signal: "alibaba/page-agent · 总 24.5k stars",
    why: "浏览器自动化新方向，产品经理可探索无代码交互场景。",
  ...
  },
  {
    ...
    tagline: "Rust · 热门",
    oneLiner: "隐私优先的AI会议助手，本地实时转录、说话人识别和总结，无需云端。",
    signal: "Zackriya-Solutions/meetily · 总 18.5k stars",
    why: "本地化AI会议工具，满足隐私需求，产品经理可参考其架构。",
    link: "https://github.com/Zackriya-Solutions/meetily",
    weeklyDelta: 2972,
  },
  {
    slug: "fluidvoice", name: "FluidVoice", category: "rising",
    tagline: "Swift · 热门",
    oneLiner: "macOS最快听写应用，设备端语音转文字，自带AI增强模型。",
    signal: "altic-dev/FluidVoice · 总 6.3k stars",
    why: "本地语音识别产品，对标Wispr Flow，适合效率工具方向。",
    link: "https://github.com/altic-dev/FluidVoice",
    weeklyDelta: 2760,
  },
  {
    slug: "lingbot-map", name: "lingbot-map", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "前馈式3D基础模型，从流式数据实时重建场景。",
    signal: "Robbyant/lingbot-map · 总 10k stars",
    why: "3D视觉前沿，产品经理可关注AR/VR场景重建应用。",
