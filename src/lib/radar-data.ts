...
export const starterSkills: StarterSkill[] = [
  ...
  // ---- rising 本周新星：GitHub Trending Weekly TOP 10（按本周新增 stars 倒序，每周快照） ----
  {
    ...
    tagline: "AI 视频生产",
    oneLiner: "全球首个开源、agentic 的视频生产系统 —— 用一组 agent 自动剪辑、配音、出片。",
    signal: "calesthio/OpenMontage · 总 27.6k stars",
    why: "AI 视频生产是这一两周最被讨论的方向，开源版本一出立刻冲到第一。",
  ...
  },
  {
    ...
    tagline: "代码记忆 MCP",
    oneLiner: "高性能代码智能 MCP server，用知识图谱给 AI 提供长期代码库记忆。",
    signal: "DeusData/codebase-memory-mcp · 总 20.4k stars",
    why: "解决「AI 一离开当前窗口就忘了代码库」这个老问题，MCP 生态里最受关注的新仓。",
    link: "https://github.com/DeusData/codebase-memory-mcp",
    weeklyDelta: 8926,
  },
  {
    slug: "agent-reach", name: "Agent-Reach", category: "rising",
    tagline: "全网信息接入",
    oneLiner: "给 AI agent 一双能看遍互联网的眼睛 —— 跨主流平台抓取、搜索、订阅。",
    signal: "Panniantong/Agent-Reach · 总 44.9k stars",
    why: "之前国内做内容/调研都缺这一步，社区版直接补齐了 agent 的「信息源」。",
  ...
  },
  {
    ...
    tagline: "LLM 金融分析",
    oneLiner: "LLM 驱动的多市场股票分析，实时新闻 + 仪表盘 + 每日报告，全自动出活。",
    signal: "ZhuLinsen/daily_stock_analysis · 总 51.4k stars",
    why: "把 LLM 接到真实金融数据上的范本，PM 学怎么「让 AI 跑日常报告」的好参考。",
  ...
  },
  {
    ...
    tagline: "视觉规范格式",
    oneLiner: "Google Labs 出的格式规范：用一份 design.md 把视觉系统讲给 coding agent 听。",
    signal: "google-labs-code/design.md · 总 23.0k stars",
    why: "AI 写前端总跑偏是因为没有共享的设计语言，这份 spec 直接解这个问题。",
    link: "https://github.com/google-labs-code/design.md",
    weeklyDelta: 6728,
  },
  {
    slug: "cognee", name: "cognee", category: "rising",
    tagline: "AI 记忆平台",
    oneLiner: "开源 AI 记忆平台 —— 用知识图谱给 agent 装上持久化记忆，不再每次从零开始。",
    signal: "topoteretes/cognee · 总 25.1k stars",
    why: "「Agent 记忆」是这半年的硬命题，cognee 是开源方向里最完整的一套。",
    link: "https://github.com/topoteretes/cognee",
    weeklyDelta: 6064,
  },
  {
    slug: "ai-website-cloner", name: "ai-website-cloner-template", category: "rising",
    tagline: "网站克隆",
    oneLiner: "一条命令让 AI coding agent 克隆任意网站 —— PM 拿来做竞品快速 demo 极顺。",
    signal: "JCodesMore/ai-website-cloner-template · 总 23.2k stars",
    why: "做产品 demo 经常需要「先做一个看起来像样的」，这种模板把入门成本压到零。",
    link: "https://github.com/JCodesMore/ai-website-cloner-template",
    weeklyDelta: 5317,
  },
  {
    slug: "anthropic-cybersec-skills", name: "Anthropic-Cybersecurity-Skills", category: "rising",
    tagline: "安全 Skill 库",
    oneLiner: "817 个结构化网络安全 Skill，对齐 6 大安全框架，给 AI agent 装上「安全合规」工具箱。",
    signal: "mukul975/Anthropic-Cybersecurity-Skills · 总 22.8k stars",
    why: "Skill 思路从 PM/Coding 延伸到安全领域，预示这套范式会被各垂直场景照搬。",
  ...
  },
  {
    ...
    tagline: "AI 视频编辑器",
    oneLiner: "为 AI 时代设计的 macOS 视频编辑器 —— 把传统剪辑步骤交给 agent 自动完成。",
    signal: "palmier-io/palmier-pro · 总 9.4k stars",
    why: "和 OpenMontage 形成「开源框架 + 桌面产品」的双轨，AI 视频赛道明显在加热。",
  ...
  },
  {
    ...
    tagline: "git 保险栓",
    oneLiner: "「git push no-mistakes」—— 一条命令把容易翻车的 git 操作变成不可逆错误前的最后一道防线。",
    signal: "kunchenguid/no-mistakes · 总 4.2k stars",
    why: "vibecoding 时代最大的隐患就是 AI 改飞了你回不去，这个小工具是手动安全网。",
