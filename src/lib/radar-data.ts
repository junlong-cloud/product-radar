...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "meetily", name: "meetily", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "基于Rust的AI会议助手，支持本地实时转录、说话人识别和摘要，无需联网，保护隐私。",
    signal: "Zackriya-Solutions/meetily · 总 23.8k stars",
    why: "AI产品经理可关注其本地化、隐私优先的会议记录产品形态。",
    link: "https://github.com/Zackriya-Solutions/meetily",
    weeklyDelta: 7440,
  },
  {
    slug: "system-prompts-leaks", name: "system_prompts_leaks", category: "rising",
    tagline: "JavaScript · 热门",
    oneLiner: "收集并公开了Anthropic、OpenAI、Google等多家AI模型的系统提示词，持续更新。",
    signal: "asgeirtj/system_prompts_leaks · 总 57k stars",
    why: "了解竞品系统提示词设计，启发自己的AI产品提示工程。",
    link: "https://github.com/asgeirtj/system_prompts_leaks",
    weeklyDelta: 7155,
  },
  {
    slug: "officecli", name: "OfficeCLI", category: "rising",
    tagline: "C# · 热门",
    oneLiner: "专为AI代理设计的Office命令行工具，可读写Word、Excel、PPT，无需安装Office。",
    signal: "iOfficeAI/OfficeCLI · 总 15.8k stars",
    why: "AI产品经理可探索AI自动化办公场景，降低集成成本。",
    link: "https://github.com/iOfficeAI/OfficeCLI",
    weeklyDelta: 6978,
  },
  {
    slug: "omniroute", name: "OmniRoute", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "免费AI网关，一个接口连接231+模型提供商，支持智能回退和令牌压缩，节省成本。",
    signal: "diegosouzapw/OmniRoute · 总 16.5k stars",
    why: "多模型切换和成本优化方案，适合AI产品快速迭代。",
    link: "https://github.com/diegosouzapw/OmniRoute",
    weeklyDelta: 4506,
  },
  {
    slug: "claude-video", name: "claude-video", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "让Claude能观看视频：下载、抽帧、转录后交给Claude分析。",
    signal: "bradautomates/claude-video · 总 8k stars",
    why: "扩展AI多模态能力，产品经理可思考视频理解应用场景。",
    link: "https://github.com/bradautomates/claude-video",
    weeklyDelta: 4353,
  },
  {
    slug: "herdr", name: "herdr", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "终端里的AI代理多路复用器，可同时管理多个AI代理。",
    signal: "ogulcancelik/herdr · 总 16k stars",
    why: "提升AI代理开发效率，值得关注多代理协作的产品设计。",
    link: "https://github.com/ogulcancelik/herdr",
    weeklyDelta: 3928,
  },
  {
    slug: "codex-plugin-cc", name: "codex-plugin-cc", category: "rising",
    tagline: "JavaScript · 热门",
    oneLiner: "在Claude Code中调用OpenAI Codex进行代码审查或任务委派。",
    signal: "openai/codex-plugin-cc · 总 28.2k stars",
    why: "跨模型协作的实践，启发AI产品经理设计多模型工作流。",
    link: "https://github.com/openai/codex-plugin-cc",
    weeklyDelta: 2803,
  },
  {
    slug: "cubesandbox", name: "CubeSandbox", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "为AI代理设计的轻量级沙箱，支持即时、并发、安全的运行环境。",
    signal: "TencentCloud/CubeSandbox · 总 9.9k stars",
    why: "AI代理安全隔离方案，产品经理需关注代理执行环境。",
    link: "https://github.com/TencentCloud/CubeSandbox",
    weeklyDelta: 2490,
  },
  {
    slug: "desktopcommandermcp", name: "DesktopCommanderMCP", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "为Claude提供终端控制、文件搜索和差异编辑能力的MCP服务器。",
    signal: "wonderwhy-er/DesktopCommanderMCP · 总 8.1k stars",
    why: "增强AI代理的本地操作能力，产品经理可参考MCP扩展模式。",
    link: "https://github.com/wonderwhy-er/DesktopCommanderMCP",
    weeklyDelta: 1678,
  },
  {
    slug: "abseil-cpp", name: "abseil-cpp", category: "rising",
    tagline: "C++ · 热门",
    oneLiner: "Google开源的C++通用库，提供容器、算法、字符串等基础组件。",
    signal: "abseil/abseil-cpp · 总 18k stars",
    why: "底层基础设施，AI产品经理可了解其在高性能场景的应用。",
