...
export const starterSkills: StarterSkill[] = [
  ...
  // ---- rising 本周新星：GitHub Trending Weekly TOP 10（按本周新增 stars 倒序，每周快照） ----
  {
    ...
    tagline: "C · 热门",
    oneLiner: "高性能代码智能MCP服务器，将代码库索引为持久知识图谱，支持158种语言，毫秒级查询，单静态二进制零依赖。",
    signal: "DeusData/codebase-memory-mcp · 总 25.3k stars",
    why: "AI产品经理可了解如何为代码分析工具构建高效知识图谱，提升开发体验。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "基于Claude Code/Codex的价值投资研究框架，融合四位大师方法论与多Agent并行分析。",
    signal: "xbtlin/ai-berkshire · 总 9.1k stars",
    why: "展示AI Agent在金融研究领域的应用，值得关注多Agent协作的产品形态。",
  ...
  },
  {
    ...
    tagline: "Haskell · 热门",
    oneLiner: "首个无需任何用户标识的隐私优先消息网络，支持iOS、Android和桌面端。",
    signal: "simplex-chat/simplex-chat · 总 17.7k stars",
    why: "探索去中心化、无身份标识的通信产品设计，对隐私赛道有启发。",
  ...
  },
  {
    ...
    oneLiner: "用AI编码代理一键克隆任意网站，只需一条命令。",
    signal: "JCodesMore/ai-website-cloner-template · 总 25.2k stars",
    why: "AI自动化网站克隆工具，可快速原型验证或竞品分析，实用性强。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "开源AI渗透测试工具，自动发现并修复应用安全漏洞。",
    signal: "usestrix/strix · 总 33.8k stars",
    why: "AI+安全赛道，产品经理可了解如何用AI提升安全测试效率。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "开源AI记忆平台，为智能体提供跨会话的持久长期记忆，基于自托管知识图谱引擎。",
    signal: "topoteretes/cognee · 总 26.8k stars",
    why: "解决AI Agent记忆持久化问题，是构建连续对话产品的关键基础设施。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "用编码代理编辑视频，实现视频处理的自动化。",
    signal: "browser-use/video-use · 总 14.3k stars",
    why: "AI视频编辑新范式，产品经理可关注编码代理在创意工具中的应用。",
  ...
  },
  {
    ...
    tagline: "TypeScript · 热门",
    oneLiner: "免费AI网关，一个端点连接231+提供商，支持智能回退和令牌压缩，节省15-95%成本。",
    signal: "diegosouzapw/OmniRoute · 总 10.6k stars",
    why: "降低AI API调用成本，产品经理可评估集成多种模型的经济性。",
  ...
  },
  {
    ...
    tagline: "Rust · 热门",
    oneLiner: "终端中的智能体复用器，管理多个AI代理的交互。",
    signal: "ogulcancelik/herdr · 总 10.5k stars",
    why: "终端内多Agent管理工具，适合开发者体验和产品原型快速迭代。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "前馈式3D基础模型，从流式数据重建场景。",
    signal: "Robbyant/lingbot-map · 总 9.5k stars",
    why: "3D视觉前沿，产品经理可关注实时3D重建在AR/VR等场景的潜力。",
