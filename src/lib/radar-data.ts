...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "ai-agent-book", name: "ai-agent-book", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "《深入理解 AI Agent》开源书籍，包含设计原理、工程实践和配套代码，适合想系统学习智能体开发的读者。",
    signal: "bojieli/ai-agent-book · 总 22.3k stars",
    why: "AI Agent 是当前热门方向，这本书从原理到代码全覆盖，产品经理可快速建立技术认知。",
    link: "https://github.com/bojieli/ai-agent-book",
    weeklyDelta: 15909,
  },
  {
    slug: "worldmonitor", name: "worldmonitor", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "实时全球情报仪表盘，利用 AI 聚合新闻、监控地缘政治和基础设施，提供统一态势感知界面。",
    signal: "koala73/worldmonitor · 总 75.1k stars",
    why: "AI+情报分析赛道，产品经理可借鉴其多源数据聚合与可视化设计思路。",
  ...
  },
  {
    ...
    tagline: "Shell · 热门",
    oneLiner: "从作者 .agents 目录中提取的实用技能集合，帮助 AI 编码代理更高效工作。",
    signal: "mattpocock/skills · 总 190.8k stars",
    why: "AI 代理技能库，产品经理可了解如何为智能体设计可复用的能力模块。",
    link: "https://github.com/mattpocock/skills",
    weeklyDelta: 12238,
  },
  {
    ...
    tagline: "TypeScript · 热门",
    oneLiner: "免费 MIT 开源 AI 网关，一个接口接入 290+ 提供商、500+ 模型，支持自动回退和压缩节省 15-95% 令牌。",
    signal: "diegosouzapw/OmniRoute · 总 31.7k stars",
    why: "多模型统一接入与成本优化工具，产品经理可直接用于降低 AI 产品调用成本。",
    link: "https://github.com/diegosouzapw/OmniRoute",
    weeklyDelta: 10912,
  },
  {
    slug: "i-have-adhd", name: "i-have-adhd", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "为编码代理设计的技能，防止它把答案埋没在冗长输出中，生成更简洁的 ADHD 友好回复。",
    signal: "ayghri/i-have-adhd · 总 11k stars",
    why: "关注 AI 输出体验，产品经理可思考如何优化智能体的交互方式。",
    link: "https://github.com/ayghri/i-have-adhd",
    weeklyDelta: 6991,
  },
  {
    slug: "code-review-graph", name: "code-review-graph", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "本地优先的代码智能图，为 MCP 和 CLI 构建持久化代码地图，让 AI 工具只读取相关部分，减少上下文。",
    signal: "tirth8205/code-review-graph · 总 26.8k stars",
    why: "代码库上下文优化工具，产品经理可了解如何提升 AI 在大型项目中的效率。",
    link: "https://github.com/tirth8205/code-review-graph",
    weeklyDelta: 6006,
  },
  {
    slug: "openship", name: "openship", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "自托管的部署平台，让你自己掌控应用部署流程。",
    signal: "oblien/openship · 总 8.8k stars",
    why: "自部署平台，产品经理可关注私有化部署趋势及其对产品架构的影响。",
    link: "https://github.com/oblien/openship",
    weeklyDelta: 5844,
  },
  {
    slug: "pi", name: "pi", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "AI 代理工具包，包含统一 LLM API、代理循环、终端 UI 和编码代理 CLI。",
    signal: "earendil-works/pi · 总 78.8k stars",
    why: "一站式 AI 代理开发工具，产品经理可快速搭建原型验证想法。",
    link: "https://github.com/earendil-works/pi",
    weeklyDelta: 5389,
  },
  {
    slug: "jcode", name: "jcode", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "号称最省内存的测试框架，用 Rust 编写，专注于高效运行。",
    signal: "1jehuang/jcode · 总 11.8k stars",
    why: "高性能测试工具，产品经理可了解 Rust 在基础设施中的优势。",
    link: "https://github.com/1jehuang/jcode",
    weeklyDelta: 2909,
  },
  {
    slug: "pi-web", name: "pi-web", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "pi 编码代理的 Web 界面，提供图形化操作方式。",
    signal: "agegr/pi-web · 总 3k stars",
    why: "AI 编码代理的 UI 层，产品经理可参考其交互设计。",
