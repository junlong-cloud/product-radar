...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "moneyprinterturbo", name: "MoneyPrinterTurbo", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "用AI大模型和自动化流程，输入主题或关键词就能自动生成高清短视频，适合快速做内容。",
    signal: "harry0703/MoneyPrinterTurbo · 总 115.3k stars",
    why: "AI生成视频是热门赛道，产品经理可了解自动化内容生产工具如何落地。",
    link: "https://github.com/harry0703/MoneyPrinterTurbo",
    weeklyDelta: 11167,
  },
  {
    slug: "public-apis", name: "public-apis", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "汇总了大量免费可用的API接口，涵盖各种领域，方便开发者查找和调用。",
    signal: "public-apis/public-apis · 总 469.2k stars",
    why: "产品经理可快速找到可用API，加速原型验证和功能集成。",
  ...
  },
  {
    ...
    tagline: "Rust · 热门",
    oneLiner: "用Rust写的本地优先鼠标驱动替代工具，可重映射按键、调DPI，无需账号和遥测。",
    signal: "AprilNEA/OpenLogi · 总 15k stars",
    why: "关注本地优先和隐私保护的产品设计，可借鉴其无云端依赖的架构。",
    link: "https://github.com/AprilNEA/OpenLogi",
    weeklyDelta: 6078,
  },
  {
    slug: "openviking", name: "OpenViking", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "为AI代理设计的自进化上下文数据库，统一管理记忆、知识检索和技能。",
    signal: "volcengine/OpenViking · 总 32.5k stars",
    why: "AI代理的记忆管理是核心挑战，此项目提供新思路，值得产品经理关注。",
  ...
  },
  {
    ...
    tagline: "Shell · 热门",
    oneLiner: "一个美观、现代且带主见的Linux发行版，提供开箱即用的体验。",
    signal: "basecamp/omarchy · 总 29.2k stars",
    why: "操作系统定制化趋势，产品经理可了解面向开发者的系统级产品设计。",
    link: "https://github.com/basecamp/omarchy",
    weeklyDelta: 3660,
  },
  {
    slug: "cordis", name: "cordis", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "一个时空组合性的元框架，用于构建可组合的时空应用。",
    signal: "cordiverse/cordis · 总 7.3k stars",
    why: "新兴的时空计算框架，可能影响未来LBS和实时应用的产品设计。",
    link: "https://github.com/cordiverse/cordis",
    weeklyDelta: 2725,
  },
  {
    slug: "modular", name: "modular", category: "rising",
    tagline: "Mojo · 热门",
    oneLiner: "Modular平台包含MAX和Mojo语言，旨在统一AI开发与部署。",
    signal: "modular/modular · 总 29k stars",
    why: "Mojo语言性能强，产品经理可关注AI基础设施的演进方向。",
    link: "https://github.com/modular/modular",
    weeklyDelta: 2176,
  },
  {
    slug: "plugins", name: "plugins", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "Cursor编辑器的插件规范及官方插件，支持扩展编辑器功能。",
    signal: "cursor/plugins · 总 4.8k stars",
    why: "AI编程工具生态，产品经理可了解插件化如何增强产品能力。",
    link: "https://github.com/cursor/plugins",
    weeklyDelta: 1761,
  },
  {
    slug: "omlx", name: "omlx", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "为Apple Silicon设计的LLM推理服务器，支持连续批处理和SSD缓存，菜单栏管理。",
    signal: "jundot/omlx · 总 20.5k stars",
    why: "本地运行大模型是趋势，产品经理可关注端侧AI部署的实用方案。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "Claude Cowork和Code的社区插件市场，可提交和获取插件。",
    signal: "anthropics/claude-plugins-community · 总 983 stars",
    why: "AI助手插件生态，产品经理可借鉴社区驱动扩展的模式。",
