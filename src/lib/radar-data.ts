...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "archify", name: "archify", category: "rising",
    tagline: "JavaScript · 热门",
    oneLiner: "一个Agent技能，能生成漂亮且可验证的架构图、流程图、时序图等，输出为自带动画的HTML文件，方便导出。",
    signal: "tt-a1i/archify · 总 35.6k stars",
    why: "AI产品经理可快速产出架构图，用于方案汇报或文档，提升沟通效率。",
    link: "https://github.com/tt-a1i/archify",
    weeklyDelta: 18103,
  },
  {
    slug: "awesome-gpt-image-2", name: "awesome-gpt-image-2", category: "rising",
    tagline: "JavaScript · 热门",
    oneLiner: "一个GPT-Image2提示词引擎与模板库，包含530+案例逆向工程和20+套工业级模板，提炼出Skills，持续更新。",
    signal: "freestylefly/awesome-gpt-image-2 · 总 25.9k stars",
    why: "AI产品经理可借鉴工业级提示词模板，提升图像生成类产品的效果与稳定性。",
    link: "https://github.com/freestylefly/awesome-gpt-image-2",
    weeklyDelta: 13413,
  },
  {
    slug: "omarchy", name: "omarchy", category: "rising",
    tagline: "Shell · 热门",
    oneLiner: "一个美观、现代且个性化的Linux发行版，提供开箱即用的桌面体验。",
    signal: "omacom/omarchy · 总 35.7k stars",
    why: "AI产品经理可关注其设计理念，用于产品界面或交互的灵感参考。",
    link: "https://github.com/omacom/omarchy",
    weeklyDelta: 6692,
  },
  {
    slug: "ai-job-search", name: "ai-job-search", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "一个基于Claude Code的AI求职应用框架，能评估职位、定制简历、写求职信、准备面试，本地运行。",
    signal: "MadsLorentzen/ai-job-search · 总 38.6k stars",
    why: "AI产品经理可研究其自动化流程，探索AI在招聘领域的应用场景。",
    link: "https://github.com/MadsLorentzen/ai-job-search",
    weeklyDelta: 5348,
  },
  {
    slug: "ai-engineering-from-scratch", name: "ai-engineering-from-scratch", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "一个从零开始学习AI工程的项目，涵盖学习、构建、交付全流程。",
    signal: "rohitg00/ai-engineering-from-scratch · 总 51.4k stars",
    why: "AI产品经理可系统学习AI工程知识，提升技术理解与产品落地能力。",
    link: "https://github.com/rohitg00/ai-engineering-from-scratch",
    weeklyDelta: 3720,
  },
  {
    slug: "openlogi", name: "OpenLogi", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "一个用Rust编写的本地优先鼠标驱动替代工具，支持按键重映射、DPI调节和SmartShift，无需账号和遥测。",
    signal: "AprilNEA/OpenLogi · 总 17.9k stars",
    why: "AI产品经理可关注其本地优先设计，思考AI产品中隐私与数据处理的平衡。",
    link: "https://github.com/AprilNEA/OpenLogi",
    weeklyDelta: 3406,
  },
  {
    slug: "freellmapi", name: "freellmapi", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "一个聚合34个免费LLM提供商、635个模型端点的API，提供统一接口，支持智能路由和自动故障转移。",
    signal: "tashfeenahmed/freellmapi · 总 23k stars",
    why: "AI产品经理可低成本测试多模型，快速验证产品原型，降低开发成本。",
    link: "https://github.com/tashfeenahmed/freellmapi",
    weeklyDelta: 3037,
  },
  {
    slug: "claude-plugins-community", name: "claude-plugins-community", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "Claude Cowork和Claude Code的社区插件市场，只读镜像，可提交插件。",
    signal: "anthropics/claude-plugins-community · 总 2.9k stars",
    why: "AI产品经理可了解Claude生态的插件机制，探索AI工具的可扩展性。",
    link: "https://github.com/anthropics/claude-plugins-community",
    weeklyDelta: 2162,
  },
  {
    slug: "maka", name: "maka", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "一个本地优先的AI Agent工作空间，记录模型消息、工具调用等事件为追加日志。",
    signal: "apache/maka · 总 4.2k stars",
    why: "AI产品经理可借鉴其日志设计，用于AI Agent的可观测性与调试。",
    link: "https://github.com/apache/maka",
    weeklyDelta: 1973,
  },
  {
    slug: "claude-plugins-official", name: "claude-plugins-official", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "Anthropic官方管理的Claude Code高质量插件目录。",
    signal: "anthropics/claude-plugins-official · 总 35.6k stars",
    why: "AI产品经理可获取官方认证的插件，提升Claude Code的使用效率。",
