...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "opencut", name: "OpenCut", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "开源替代剪映的视频编辑工具，支持多轨道剪辑、特效和导出，无需付费。",
    signal: "OpenCut-app/OpenCut · 总 76.2k stars",
    why: "AI视频生成赛道，开源工具可集成AI能力，降低产品开发成本。",
  ...
  },
  {
    ...
    tagline: "Shell · 热门",
    oneLiner: "从作者个人AI代理目录中提取的实用技能集合，面向真实工程师。",
    signal: "mattpocock/skills · 总 178.3k stars",
    why: "展示AI Agent技能库的构建思路，可借鉴用于产品功能设计。",
    link: "https://github.com/mattpocock/skills",
    weeklyDelta: 10983,
  },
  {
    slug: "hallmark", name: "hallmark", category: "rising",
    tagline: "CSS · 热门",
    oneLiner: "为Claude Code、Cursor等AI编程工具提供反AI味的设计规范，提升输出质量。",
    signal: "Nutlope/hallmark · 总 13.8k stars",
    why: "解决AI生成内容同质化问题，对AI产品体验优化有参考价值。",
    link: "https://github.com/Nutlope/hallmark",
    weeklyDelta: 9193,
  },
  {
    slug: "awesome-llm-apps", name: "awesome-llm-apps", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "100多个可直接运行的AI Agent和RAG应用示例，支持克隆和定制。",
    signal: "Shubhamsaboo/awesome-llm-apps · 总 124.9k stars",
    why: "丰富的AI应用模板库，快速验证产品想法，降低原型开发门槛。",
    link: "https://github.com/Shubhamsaboo/awesome-llm-apps",
    weeklyDelta: 6211,
  },
  {
    slug: "vibe-trading", name: "Vibe-Trading", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "个人交易Agent，基于市场情绪进行自动化投资决策。",
    signal: "HKUDS/Vibe-Trading · 总 25.5k stars",
    why: "AI+金融赛道，Agent自主交易的产品形态值得关注。",
  ...
  },
  {
    ...
    tagline: "C# · 热门",
    oneLiner: "专为AI Agent设计的Office命令行工具，无需安装Office即可读写Word/Excel/PPT。",
    signal: "iOfficeAI/OfficeCLI · 总 19.9k stars",
    why: "AI自动化办公基础设施，可直接集成到Agent产品中提升文档处理能力。",
    link: "https://github.com/iOfficeAI/OfficeCLI",
    weeklyDelta: 4269,
  },
  {
    slug: "deeptutor", name: "DeepTutor", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "终身个性化辅导系统，根据学习者知识状态动态调整教学策略。",
    signal: "HKUDS/DeepTutor · 总 28.2k stars",
    why: "AI教育赛道，自适应学习的产品设计思路可迁移至其他个性化场景。",
    link: "https://github.com/HKUDS/DeepTutor",
    weeklyDelta: 2375,
  },
  {
    slug: "codex", name: "codex", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "轻量级终端编码Agent，直接在命令行中辅助编写代码。",
    signal: "openai/codex · 总 99.9k stars",
    why: "AI编程助手新形态，终端交互方式对开发者工具产品有启发。",
    link: "https://github.com/openai/codex",
    weeklyDelta: 2361,
  },
  {
    slug: "ui-skills", name: "ui-skills", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "面向设计工程师的UI技能集合，提升前端开发与设计协作效率。",
    signal: "ibelick/ui-skills · 总 5.6k stars",
    why: "AI+设计工具方向，技能库形式可复用至其他垂直领域。",
    link: "https://github.com/ibelick/ui-skills",
    weeklyDelta: 1669,
  },
  {
    slug: "cangjie-skill", name: "cangjie-skill", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "将书籍、长视频、播客等高价值内容蒸馏为可执行的Agent技能。",
    signal: "kangarooking/cangjie-skill · 总 4k stars",
    why: "内容到技能的转化思路，为AI知识产品化提供新范式。",
