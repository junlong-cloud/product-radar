...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "reverse-skill", name: "reverse-skill", category: "rising",
    tagline: "PowerShell · 热门",
    oneLiner: "一个为AI编程客户端提供逆向工程、渗透测试等安全技能的智能路由包，能自动选择工具并积累经验库。",
    signal: "zhaoxuya520/reverse-skill · 总 22.6k stars",
    why: "安全赛道AI应用，展示如何将专业技能封装为AI可调用的工具链，对AI产品设计有启发。",
    link: "https://github.com/zhaoxuya520/reverse-skill",
    weeklyDelta: 9784,
  },
  {
    slug: "pdf-inspector", name: "pdf-inspector", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "用Rust写的PDF检查库，能快速识别PDF是扫描件还是文本型，并提取文字，用于智能分流。",
    signal: "firecrawl/pdf-inspector · 总 13.9k stars",
    why: "文档处理是AI落地高频场景，此库性能高，可集成到RAG流程，值得关注。",
    link: "https://github.com/firecrawl/pdf-inspector",
    weeklyDelta: 8641,
  },
  {
    slug: "tencentdb-agent-memory", name: "TencentDB-Agent-Memory", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "腾讯云推出的AI智能体团队记忆中心，把对话、文档、代码转化为可共享复用的四类记忆资产。",
    signal: "TencentCloud/TencentDB-Agent-Memory · 总 18.8k stars",
    why: "多智能体协作是趋势，团队级记忆管理是刚需，产品形态值得借鉴。",
    link: "https://github.com/TencentCloud/TencentDB-Agent-Memory",
    weeklyDelta: 8003,
  },
  {
    slug: "ai-for-beginners", name: "AI-For-Beginners", category: "rising",
    tagline: "Jupyter Notebook · 热门",
    oneLiner: "微软出品的AI入门教程，12周24课，覆盖AI基础、神经网络、生成式AI等，适合新手。",
    signal: "microsoft/AI-For-Beginners · 总 64.1k stars",
    why: "系统学习AI知识的免费资源，帮助产品经理快速建立技术认知。",
    link: "https://github.com/microsoft/AI-For-Beginners",
    weeklyDelta: 5514,
  },
  {
    slug: "airllm", name: "airllm", category: "rising",
    tagline: "Jupyter Notebook · 热门",
    oneLiner: "让70B大模型在单张4GB显卡上运行的推理库，通过优化显存实现低资源部署。",
    signal: "lyogavin/airllm · 总 30.4k stars",
    why: "低成本部署大模型是行业痛点，此方案对资源有限的产品团队有实用价值。",
    link: "https://github.com/lyogavin/airllm",
    weeklyDelta: 5129,
  },
  {
    slug: "deepseek-reasonix", name: "DeepSeek-Reasonix", category: "rising",
    tagline: "Go · 热门",
    oneLiner: "一个面向终端、专为DeepSeek优化的AI编程助手，利用前缀缓存保持运行稳定。",
    signal: "esengine/DeepSeek-Reasonix · 总 33.5k stars",
    why: "AI编程工具竞争激烈，其缓存优化思路对提升产品体验有参考意义。",
    link: "https://github.com/esengine/DeepSeek-Reasonix",
    weeklyDelta: 4709,
  },
  {
    slug: "book-to-skill", name: "book-to-skill", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "把技术书籍PDF转换成Claude Code技能的工具，让你边工作边查阅和运用书中知识。",
    signal: "virgiliojr94/book-to-skill · 总 19.5k stars",
    why: "知识库到可执行技能的转化是AI应用方向，此工具展示了具体实现路径。",
    link: "https://github.com/virgiliojr94/book-to-skill",
    weeklyDelta: 4121,
  },
  {
    slug: "kaneo", name: "kaneo", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "开源项目管理工具，界面简洁，功能齐全，强调易用性和灵活性。",
    signal: "usekaneo/kaneo · 总 7.9k stars",
    why: "项目管理是AI产品经理常用工具，开源可定制，值得体验其设计理念。",
    link: "https://github.com/usekaneo/kaneo",
    weeklyDelta: 1952,
  },
  {
    slug: "skills", name: "skills", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "谷歌官方发布的Agent Skills集合，为AI智能体提供谷歌产品和技术相关的技能模块。",
    signal: "google/skills · 总 17.3k stars",
    why: "巨头布局Agent技能生态，了解其技能定义方式有助于把握行业标准。",
    link: "https://github.com/google/skills",
    weeklyDelta: 1626,
  },
  {
    slug: "swarm-forge", name: "swarm-forge", category: "rising",
    tagline: "Clojure · 热门",
    oneLiner: "一个用Clojure写的简单工具，用于协调多个AI智能体协同工作。",
    signal: "unclebob/swarm-forge · 总 2.1k stars",
    why: "多智能体编排是热点，此工具轻量，可快速上手实验，适合产品原型验证。",
