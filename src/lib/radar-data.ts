...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "buzz", name: "buzz", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "一个用Rust写的去中心化群聊平台，类似蜂群思维，支持多人实时沟通。",
    signal: "block/buzz · 总 21.2k stars",
    why: "探索去中心化社交产品形态，对AI产品经理有参考价值。",
  ...
  },
  {
    ...
    oneLiner: "微软出品的AI入门课程，12周24课，覆盖AI基础、神经网络、计算机视觉等。",
    signal: "microsoft/AI-For-Beginners · 总 59.4k stars",
    why: "系统学习AI知识的免费资源，适合产品经理快速建立技术认知。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "一个Python技能包，让AI编程助手输出更简洁，避免冗长，适合ADHD用户。",
    signal: "ayghri/i-have-adhd · 总 15.8k stars",
    why: "关注AI交互体验优化，对设计面向特定人群的AI工具有启发。",
  ...
  },
  {
    ...
    tagline: "Python · 热门",
    oneLiner: "把技术书PDF转成Claude Code技能，方便边工作边查阅和复习。",
    signal: "virgiliojr94/book-to-skill · 总 15.5k stars",
    why: "AI辅助学习工具，可借鉴其将知识转化为可交互技能的产品思路。",
    link: "https://github.com/virgiliojr94/book-to-skill",
    weeklyDelta: 5223,
  },
  {
    slug: "bitchat", name: "bitchat", category: "rising",
    tagline: "Swift · 热门",
    oneLiner: "用蓝牙网格实现无网聊天的应用，类似IRC风格，支持多设备互联。",
    signal: "permissionlesstech/bitchat · 总 34.2k stars",
    why: "探索离线社交场景，对AI产品经理思考低功耗连接应用有启发。",
    link: "https://github.com/permissionlesstech/bitchat",
    weeklyDelta: 4942,
  },
  {
    slug: "open-code-review", name: "open-code-review", category: "rising",
    tagline: "Go · 热门",
    oneLiner: "阿里开源代码审查工具，结合规则引擎和LLM，能精准定位代码问题。",
    signal: "alibaba/open-code-review · 总 18k stars",
    why: "企业级AI代码审查实践，了解AI在研发流程中的落地方式。",
  ...
  },
  {
    ...
    tagline: "Rust · 热门",
    oneLiner: "一个Rust写的内存效率极高的测试框架，适合资源受限环境。",
    signal: "1jehuang/jcode · 总 15.3k stars",
    why: "关注AI模型部署中的资源优化，对边缘计算产品有参考。",
    link: "https://github.com/1jehuang/jcode",
    weeklyDelta: 3620,
  },
  {
    slug: "airi", name: "airi", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "自托管的AI伴侣，支持实时语音聊天、玩Minecraft和Factorio，跨平台。",
    signal: "moeru-ai/airi · 总 46.6k stars",
    why: "AI陪伴产品形态探索，结合游戏和语音交互，值得关注。",
    link: "https://github.com/moeru-ai/airi",
    weeklyDelta: 3431,
  },
  {
    slug: "editor", name: "editor", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "一个在线3D建筑项目创建和分享工具，支持协作。",
    signal: "pascalorg/editor · 总 20.8k stars",
    why: "AI+3D设计工具，可借鉴其交互和协作模式。",
    link: "https://github.com/pascalorg/editor",
    weeklyDelta: 3163,
  },
  {
    slug: "aisuite", name: "aisuite", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "Python库，统一接口调用多家生成式AI提供商，简化切换。",
    signal: "andrewyng/aisuite · 总 15.9k stars",
    why: "降低AI服务集成成本，对产品快速迭代和多供应商策略有实用价值。",
