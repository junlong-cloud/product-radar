...
export const starterSkills: StarterSkill[] = [
  ...
  {
    slug: "diagram-design", name: "diagram-design", category: "rising",
    tagline: "HTML · 热门",
    oneLiner: "提供29种编辑级图表模板，用HTML和SVG实现，适合Claude Code生成清晰图表，避免Mermaid的杂乱。",
    signal: "cathrynlavery/diagram-design · 总 19.6k stars",
    why: "AI产品经理可借鉴其设计原则，提升AI生成图表的可读性和专业度。",
    link: "https://github.com/cathrynlavery/diagram-design",
    weeklyDelta: 15600,
  },
  {
    slug: "prime-agent", name: "prime-agent", category: "rising",
    tagline: "TypeScript · 热门",
    oneLiner: "一个能自我改进的强化学习智能体，用于编码工作流和长时间自主任务。",
    signal: "PrimeIntellect-ai/prime-agent · 总 16.6k stars",
    why: "展示AI智能体自我进化方向，对规划AI产品路线有参考价值。",
    link: "https://github.com/PrimeIntellect-ai/prime-agent",
    weeklyDelta: 6435,
  },
  {
    slug: "semantica", name: "semantica", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "基于图的基础设施，为上下文和可问责AI系统提供支持。",
    signal: "semantica-agi/semantica · 总 8.2k stars",
    why: "图原生架构是AI可解释性关键，值得关注其如何增强系统透明度。",
    link: "https://github.com/semantica-agi/semantica",
    weeklyDelta: 5284,
  },
  {
    slug: "needle", name: "needle", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "仅14MB的微型基础模型，可运行在手机、可穿戴设备、智能家居和机器人上。",
    signal: "cactus-compute/needle · 总 6.6k stars",
    why: "端侧小模型趋势明显，对AI产品经理设计轻量级AI功能有启发。",
    link: "https://github.com/cactus-compute/needle",
    weeklyDelta: 2950,
  },
  {
    slug: "agent-skills", name: "agent-skills", category: "rising",
    tagline: "JavaScript · 热门",
    oneLiner: "为AI编码智能体提供生产级工程技能库。",
    signal: "addyosmani/agent-skills · 总 87.8k stars",
    why: "提升AI编码效率的实用工具，可帮助产品经理理解AI辅助开发最佳实践。",
    link: "https://github.com/addyosmani/agent-skills",
    weeklyDelta: 2882,
  },
  {
    slug: "macro", name: "macro", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "统一工作空间，整合邮件、聊天、文档、任务、智能体、通话和CRM，通过@链接和共享AI记忆协同。",
    signal: "macro-inc/macro · 总 3.4k stars",
    why: "AI原生协作平台形态，值得研究其如何用AI记忆增强团队效率。",
    link: "https://github.com/macro-inc/macro",
    weeklyDelta: 2588,
  },
  {
    slug: "code-graph-rag", name: "code-graph-rag", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "针对大型代码库的RAG工具，结合知识图谱让AI查询、理解和编辑多语言代码。",
    signal: "vitali87/code-graph-rag · 总 4.4k stars",
    why: "知识图谱+RAG解决代码理解难题，对AI编程产品有直接借鉴意义。",
    link: "https://github.com/vitali87/code-graph-rag",
    weeklyDelta: 1686,
  },
  {
    slug: "tooljet", name: "ToolJet", category: "rising",
    tagline: "JavaScript · 热门",
    oneLiner: "开源企业应用生成平台，用于构建内部工具、仪表盘、业务应用、工作流和AI智能体。",
    signal: "ToolJet/ToolJet · 总 40.1k stars",
    why: "低代码+AI智能体平台，展示企业级AI应用生成趋势，适合产品经理评估。",
    link: "https://github.com/ToolJet/ToolJet",
    weeklyDelta: 1518,
  },
  {
    slug: "switchyard", name: "Switchyard", category: "rising",
    tagline: "Rust · 热门",
    oneLiner: "让LLM应用在多个模型和提供商间路由流量，保持OpenAI和Anthropic API兼容，优化成本性能。",
    signal: "NVIDIA-NeMo/Switchyard · 总 1.7k stars",
    why: "模型路由是AI应用降本增效关键，对产品经理设计多模型策略有实用价值。",
    link: "https://github.com/NVIDIA-NeMo/Switchyard",
    weeklyDelta: 1435,
  },
  {
    slug: "holehe", name: "holehe", category: "rising",
    tagline: "Python · 热门",
    oneLiner: "检查邮箱是否在Twitter、Instagram等网站注册，利用忘记密码功能获取信息。",
    signal: "megadose/holehe · 总 13.3k stars",
    why: "邮箱反查工具，可启发AI产品经理思考隐私和安全相关功能设计。",
